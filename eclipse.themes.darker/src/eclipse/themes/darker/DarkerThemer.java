...
import static eclipse.themes.darker.ThemeConstants.*;
...
//	private static final String THEME_DARKER_PREF_THEMEENABLED = "eclipse.themes.darker.theme_enabled"; //$NON-NLS-1$
	...
	public static final String[] PREF_JDT_KEYS = { "java_bracket",
			...
			"java_doc_keyword", "java_doc_link", "java_doc_tag",
			"java_keyword", "java_keyword_return", "java_multi_line_comment",
			"java_operator", "java_single_line_comment", "java_string",
			"pf_coloring_argument", "pf_coloring_assignment",
			"pf_coloring_comment", "pf_coloring_key", "pf_coloring_value",
			...
			"semanticHighlighting.class.enabled",
			"semanticHighlighting.deprecatedMember.color",
			"semanticHighlighting.deprecatedMember.enabled",
			"semanticHighlighting.enum.color",
			"semanticHighlighting.enum.enabled",
			"semanticHighlighting.field.color",
			"semanticHighlighting.field.enabled",
...
//								THEME_DARKER_PREF_THEMEENABLED, false))
	...
	private void setupPreferences() {
		...
		prefUI.put("AbstractTextEditor.Color.SelectionForeground",
				"255,255,255");
		...
		prefJDT.put("semanticHighlighting.deprecatedMember.color",
				"255,255,255");
		prefJDT.putBoolean("semanticHighlighting.deprecatedMember.enabled",
				true);
		...
		prefJDT.putBoolean("semanticHighlighting.parameterVariable.enabled",
				true);
		...
		prefJDT.putBoolean("semanticHighlighting.staticFinalField.enabled",
				true);
		...
		prefPDE.put(ThemeConstants.PDE_P_PROC_INSTR,
		            ThemeConstants.PDE_PROC_INSTR);
		prefPDE.put(ThemeConstants.PDE_P_STRING,
		            ThemeConstants.PDE_STRING);
		prefPDE.put(ThemeConstants.PDE_P_EXTERNALIZED_STRING,
		            ThemeConstants.PDE_EXTERNALIZED_STRING);
		prefPDE.put(ThemeConstants.PDE_P_DEFAULT, 
		            ThemeConstants.PDE_DEFAULT);
		prefPDE.put(ThemeConstants.PDE_P_TAG,
		            ThemeConstants.PDE_TAG);
        prefPDE.put(ThemeConstants.PDE_P_HEADER_KEY,
                    ThemeConstants.PDE_HEADER_KEY);
...
//		}
	...
	// @Inject
	// public void setSelection(@EventTopic(IThemeEngine.Events.THEME_CHANGED)
	// Object data) {
